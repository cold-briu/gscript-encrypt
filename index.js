...
function mEncrypt() 
{
  ...
  var sKey    = Browser.inputBox("Enter the Key");

  if ((sKey == '') || (sKey == 'cancel'))
  {
    Browser.msgBox("Please Enter A Key!  Encryption Aborted!");
    return false; 
  }
  ...
  //sheet.getRange("E1").setValue(range.getRowIndex());
  //sheet.getRange("E2").setValue(range.getColumnIndex());
  //sheet.getRange("E3").setValue(range.getLastRow());
  //sheet.getRange("E4").setValue(range.getLastColumn());
...
function mDecrypt() 
{
  ...
  if ((sKey == '') ||(sKey == 'cancel'))
  {
    Browser.msgBox("Please Enter A Key!  Decryption Aborted!");
    return false; 
  }
